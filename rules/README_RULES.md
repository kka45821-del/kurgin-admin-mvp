...
Раздел «Цены» должен использовать двухстрочную навигацию, чтобы вкладки не уезжали за край экрана.

Первая строка — основная ценовая цепочка.

Вторая строка — дополнительные просмотры:

- Index
- Просмотр маржи

Это интерфейсное изменение. Формулы и расчёты не меняет.
