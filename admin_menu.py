...
ADMIN_MENU = [
    {
        "id": "dashboard", "title": "Обзор", "icon": "◇", "status": ACTIVE,
    ...
    {
        "id": "catalog", "title": "Каталог", "icon": "💎", "status": ACTIVE,
    ...
    {
        "id": "orders", "title": "Заказы", "icon": "🧾", "status": STUB,
    ...
    {
        "id": "requests", "title": "Заявки", "icon": "📩", "status": ACTIVE,
    ...
    {
        "id": "analyzer", "title": "Analyzer", "icon": "⚙️", "status": STUB,
    ...
    {
        "id": "index", "title": "Index", "icon": "📊", "status": STUB,
    ...
    {
        "id": "content", "title": "Контент", "icon": "📝", "status": ACTIVE,
    ...
    {
        "id": "users", "title": "Пользователи", "icon": "👤", "status": STUB,
    ...
    {
        "id": "specialists", "title": "Специалисты", "icon": "🧑‍💼", "status": STUB,
    ...
    {
        "id": "suppliers", "title": "Поставщики", "icon": "🏭", "status": RESTRICTED,
    ...
    {
        "id": "documents", "title": "Документы", "icon": "📄", "status": STUB,
    ...
    {
        "id": "navigation", "title": "Навигация", "icon": "🧭", "status": ACTIVE,
    ...
    {
        "id": "brand_ui", "title": "Бренд / UI", "icon": "🎨", "status": STUB,
    ...
    {
        "id": "settings", "title": "Настройки", "icon": "🛠", "status": ACTIVE,
        "description": "App mode, feature flags, data sources, import/export и logs.",
        "items": [
    ...
    {
        "id": "security", "title": "Безопасность", "icon": "🔐", "status": STUB,
