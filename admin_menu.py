...
ADMIN_MENU = [
    ...
    },
    {
        ...
        "icon": "📦",
        "status": ACTIVE,
        "description": "Главная рабочая зона: камни, загрузка Excel, партии, статусы, формирование цены, preview, публикация и разделы витрины.",
        "items": [],
    },
    {
        "id": "settings",
        ...
        "icon": "🛠",
        "status": ACTIVE,
        "description": "Минимальные рабочие настройки, публичное отображение цен и журнал действий.",
        "items": [
            {"id": "settings_page_settings", "title": "Настройки страниц и цен", "status": ACTIVE, "description": "Публичное отображение цен, страницы, разделы, фильтры и сортировки."},
