...
ADMIN_MENU = [
    {"id": "dashboard", "title": "Обзор", "icon": "◇", "status": ACTIVE, "description": "Общий статус платформы, ошибки, риски и быстрые действия.", "items": [
        {"id": "dashboard_status", "title": "Общий статус", "status": ACTIVE, "description": "Ключевые показатели платформы."},
        {"id": "dashboard_risks", "title": "Ошибки и риски", "status": ACTIVE, "description": "Критические ошибки и предупреждения."},
        {"id": "dashboard_actions", "title": "Быстрые действия", "status": ACTIVE, "description": "Быстрые переходы к загрузке, каталогу и публикации."},
    ]},
    {"id": "catalog", "title": "Каталог", "icon": "💎", "status": ACTIVE, "description": "Камни, цены, документы, статусы, разделы, импорт Excel и публикация.", "items": [
        {"id": "catalog_all", "title": "Все камни", "status": ACTIVE, "description": "Список всех камней в системе."},
    ...
    {"id": "orders", "title": "Заказы", "icon": "🧾", "status": STUB, "description": "Корзины, checkout, payment sessions, paid order processing, sold confirmation и claims. Пока не рабочая зона.", "items": [
    ...
    {"id": "requests", "title": "Заявки", "icon": "📩", "status": ACTIVE, "description": "Вопрос по камню, подбор, matching, bulk request, special order и внешний Analyzer-запрос.", "items": [
        ...
        {"id": "requests_settings", "title": "Настройки заявок", "status": STUB, "description": "Типы, статусы, обязательные поля и SLA."},
    ]},
    {"id": "analyzer", "title": "Analyzer", "icon": "⚙️", "status": STUB, "description": "Будущее управление анализом качества. Не сертификат, не оценка цены, не инвестиционная рекомендация.", "items": [
        ...
        {"id": "analyzer_tags", "title": "Теги Analyzer", "status": STUB, "description": "Правила тегов качества."},
        ...
        {"id": "analyzer_access", "title": "Доступ", "status": STUB, "description": "Права, лимиты и включение Analyzer."},
    ]},
    {"id": "index", "title": "Index", "icon": "📊", "status": STUB, "description": "KURGIN Index как рыночный ориентир. Не точная цена, не финансовый индекс, не прогноз.", "items": [
        ...
        {"id": "index_export", "title": "Export / Print", "status": FUTURE, "description": "Будущая выгрузка."},
        {"id": "index_disclaimers", "title": "Disclaimers", "status": STUB, "description": "Ограничения и пояснения."},
    ]},
    {"id": "content", "title": "Контент", "icon": "📝", "status": ACTIVE, "description": "Тексты публичных страниц, системные сообщения и пояснения.", "items": [
        {"id": "content_platform", "title": "KURGIN Platform", "status": STUB, "description": "Главная информационная страница."},
        {"id": "content_tools", "title": "Tools", "status": STUB, "description": "Страница инструментов."},
        {"id": "content_catalog", "title": "Catalog texts", "status": ACTIVE, "description": "Тексты каталога, пустые состояния, фильтры."},
        {"id": "content_detail", "title": "Stone detail texts", "status": STUB, "description": "Подписи и пояснения карточки камня."},
        {"id": "content_academy", "title": "Academy", "status": FUTURE, "description": "Образовательные материалы."},
        {"id": "content_info", "title": "Information / FAQ", "status": STUB, "description": "Вопросы, документы, доверие."},
        {"id": "content_system", "title": "System messages", "status": ACTIVE, "description": "Ошибки, предупреждения и success-сообщения."},
    ]},
    {"id": "users", "title": "Пользователи", "icon": "👤", "status": STUB, "description": "Аккаунты, роли, verification, privileges, entitlements и user history. Роль не равна привилегиям.", "items": [
        ...
        {"id": "users_verification", "title": "Verification", "status": STUB, "description": "Заявки на проверку."},
        {"id": "users_privileges", "title": "Privileges", "status": STUB, "description": "Доступные возможности."},
        {"id": "users_history", "title": "User history", "status": STUB, "description": "Избранное, корзины, заказы, заявки, отчёты."},
    ]},
    {"id": "specialists", "title": "Специалисты", "icon": "🧑‍💼", "status": STUB, "description": "Ювелиры, мастерские, консультанты, дизайнеры и профессиональные пользователи. Не marketplace специалистов.", "items": [
        {"id": "specialists_applications", "title": "Applications", "status": STUB, "description": "Заявки специалистов."},
        {"id": "specialists_profiles", "title": "Profiles", "status": STUB, "description": "Карточки специалистов."},
        ...
        {"id": "specialists_bulk_history", "title": "Bulk / matching history", "status": STUB, "description": "История профессиональных запросов."},
    ]},
    {"id": "suppliers", "title": "Поставщики", "icon": "🏭", "status": RESTRICTED, "description": "Внутренний supply-side контур. Поставщик не является публичным продавцом.", "items": [
        ...
        {"id": "suppliers_documents", "title": "Supplier documents", "status": RESTRICTED, "description": "Документы поставщика, только internal."},
    ]},
    {"id": "documents", "title": "Документы", "icon": "📄", "status": STUB, "description": "Лабораторные документы, публичные документы, версии и дисклеймеры.", "items": [
        ...
        {"id": "documents_versions", "title": "Versions", "status": STUB, "description": "Версии документов."},
        {"id": "documents_disclaimers", "title": "Disclaimers", "status": STUB, "description": "Analyzer, KURGIN Score, Index, payment, reserve, reports."},
    ]},
    {"id": "navigation", "title": "Навигация", "icon": "🧭", "status": ACTIVE, "description": "Видимость страниц, порядок, нижняя панель и внутренние ссылки.", "items": [
        ...
        {"id": "navigation_order", "title": "Page order", "status": STUB, "description": "Порядок страниц и блоков."},
        {"id": "navigation_links", "title": "Links", "status": STUB, "description": "Внутренние переходы и disabled pages."},
    ]},
    {"id": "brand_ui", "title": "Бренд / UI", "icon": "🎨", "status": STUB, "description": "Будущие визуальные настройки. Финальный дизайн пока не включаем.", "items": [
        ...
        {"id": "brand_text_size", "title": "UI text size", "status": STUB, "description": "Размеры текста для мобильного интерфейса."},
    ]},
    {"id": "settings", "title": "Настройки", "icon": "🛠", "status": ACTIVE, "description": "App mode, feature flags, data sources, import/export и logs.", "items": [
        ...
        {"id": "settings_logs", "title": "Logs", "status": STUB, "description": "Ошибки, действия админа, изменения."},
    ]},
    {"id": "security", "title": "Безопасность", "icon": "🔐", "status": STUB, "description": "Администраторы, права доступа и журнал действий.", "items": [
        ...
        {"id": "security_audit", "title": "Audit trail", "status": STUB, "description": "Кто, что и когда изменил."},
    ]},
]
