...
ADMIN_MENU = [
    ...
    },
    {
        ...
        "icon": "📦",
        "status": ACTIVE,
        "description": "Рабочая зона только для товарных категорий: Основной каталог и Крупные.",
        "items": [],
    },
    {
        "id": "other_sections",
        ...
        "icon": "▦",
        "status": ACTIVE,
        "description": "Отдельный будущий контур для мелких, средних, цветных, боковых, парных и эксклюзивных разделов.",
        "items": [],
    },
    {
        "id": "site_sync",
